 ...
 * @author Raheez
 */
public class deleteTheatre extends javax.swing.JFrame {
    ...
    /**
     * Creates new form deleteTheatre
     */
    public deleteTheatre() {
        initComponents();
        Object columns[] = {"Name", "id", "Location","no of screen","email id","password"};
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 40, 160, 40));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 40, 80, 40));

        jLabel1.setFont(new java.awt.Font("Ami R", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("ENTER THEATRE ID");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "delete from theatre where id = '" + uid+"'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
            
            JOptionPane.showMessageDialog(null, "Theatre" + uid + " has been deleted");
            defaultTableModel.getDataVector().removeAllElements();
            defaultTableModel.fireTableDataChanged();
            loadData();
           
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "Theatre not found "+e);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteTheatre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deleteTheatre().setVisible(true);
            }
        });
    }
